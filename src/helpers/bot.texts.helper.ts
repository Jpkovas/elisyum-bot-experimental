const botTexts = {
    ...
    update_available_manual: '! Uma nova atualização foi encontrada. A atualização automática foi desativada por segurança; atualize manualmente a partir de uma fonte confiável.',
