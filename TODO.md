...
- Implementar um fluxo de atualização manual assinado (verificação de assinatura/chave pública e confirmação do operador) para substituir com segurança o updater automático.
