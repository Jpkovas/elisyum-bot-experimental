...
- Criar helper dedicado para previews de links com allowlist/validação de URL (esquema, DNS/IP privada, redirects e timeout) antes de habilitar preview em comandos públicos.
