...
- Adicionar testes automatizados para `youtubeMedia` cobrindo `timestamp` textual, `seconds` em diferentes campos e fallback obrigatório para `yt-dlp` quando duração for 0.
